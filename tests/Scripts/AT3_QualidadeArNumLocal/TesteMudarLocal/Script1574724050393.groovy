...
WebUI.click(findTestObject('DashBoardLoggado/button_Locais'))

WebUI.selectOptionByValue(findTestObject('DashBoardLoggado/select_locais'), '2267095', true)

WebUI.verifyElementPresent(findTestObject('Page_Sentinel_Proyect/img_Log Out_location_img'), 0)
